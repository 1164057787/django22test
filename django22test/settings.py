"""
Django settings for django22test project.
...
SECRET_KEY = '%pj^z*(+fy4hl)=f2rct5r^8@5c341v+hr6lmw*%o(!f418if^'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'appsers.apps.AppsersConfig',
    'cachetest.apps.CachetestConfig'
]
...
ROOT_URLCONF = 'django22test.urls'
...
WSGI_APPLICATION = 'django22test.wsgi.application'
